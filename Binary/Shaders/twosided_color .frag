...
void main()
{
    ...
    color  = gl_FrontLightModelProduct.sceneColor  +
             (ambient  * (intensity * color_material /*+ gl_FrontMaterial.ambient*/)) +
             (diffuse  * (color_material /*+ gl_FrontMaterial.diffuse*/)) +
             (specular * (color_material /*+ gl_FrontMaterial.specular*/));
    ...
    color += gl_BackLightModelProduct.sceneColor  +
             (ambient  * (intensity * color_material /*+ gl_BackMaterial.ambient*/)) +
             (diffuse  * (color_material /*+ gl_BackMaterial.diffuse*/)) +
             (specular * (color_material/* + gl_BackMaterial.specular*/));
