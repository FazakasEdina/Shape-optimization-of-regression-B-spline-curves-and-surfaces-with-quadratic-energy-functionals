...
namespace cagd
{
    ...
    public:
        ...
        // calculate 0th order derivative at parameter u and v
        DCoordinate3 operator ()(GLdouble u, GLdouble v) const;
        ...
        GLvoid SetDefinitionDomain(GLdouble u_min, GLdouble u_max, GLdouble v_min, GLdouble v_max);
